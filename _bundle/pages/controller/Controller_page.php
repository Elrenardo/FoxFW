...
class Controller_page
{
	...
	{
		return $GLOBALS['Twig']->render( FoxFWKernel::getView('pages_addPage'),array('type'=>'Page'));
	}
	...
	//
	//--------------------------------------------------------------------------------
	public function viewAddArticle( $params )
	{
		return $GLOBALS['Twig']->render( FoxFWKernel::getView('pages_addPage'),array('type'=>'Article'));
	}
