...
{% block container %}
	...
	<div class="container page_model img-thumbnail col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2" >
		...
		<input type="hidden" name="path" class="form-control" value="web/page/">
		<input type="hidden" name="id"   class="form-control" value="{{ data.id }}">
		<input type="hidden" name="type" class="form-control" value="{{ data.type }}{{ type }}">
		<input type="hidden" name="twig" class="form-control" value="{{ getView('pages_page') }}">
		{{ securityForm() }}
