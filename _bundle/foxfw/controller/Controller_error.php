...
class Controller_error
{
	...
	public function e401()
	{
		...
		return $GLOBALS['Twig']->render( FoxFWKernel::getView('foxfw_error'), array(
			'error'=>'401',
			'message'=>'<b style="color:red;">Une authentification/Roles est nécessaire pour accéder à la ressource !</b><br/><a href="'.FoxFWKernel::router('user_login').'"> - Ce connecter - </a>'));
	}
